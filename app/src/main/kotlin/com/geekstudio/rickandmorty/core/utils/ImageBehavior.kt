package com.geekstudio.rickandmorty.core.utils
...
class ImageBehavior(private val ctxContext: Context, attrs: AttributeSet) :
    ...
    private fun maybeInitProperties(child: CircleImageView, dependency: View) {
        ...
        mContext?.resources?.getDimensionPixelOffset(androidx.transition.R.dimen.abc_action_bar_content_inset_material)
            ?.let {
